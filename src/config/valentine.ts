...
export const valentineConfig = {
  ...
  days: {
    ...
    "propose-day": {
      ...
      heartQuotes: [
        { emoji: "💫", text: "The day I met you, the stars rearranged themselves" },
        { emoji: "💛", text: "Every moment with you feels like a beautiful dream I never want to wake up from" },
        { emoji: "💍", text: "I don't need a perfect life — I just need you in it" },
        { emoji: "🌙", text: "You are my today, my tomorrow, and all of my forevers" },
      ],
    },
    "chocolate-day": {
      date: "2026-02-09",
